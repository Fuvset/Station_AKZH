...
class Station
{
    ...
    public Station()
    {
        ...
        Seg("m10x", 240, 256, 305, 256);
        Seg("m6j", 100, 477, 158, 477);
        Seg("m5x", 1416, 477, 1500, 477);
        Seg("m5", 1278, 477, 1410, 477);
        Seg("1c", 1296, 367, 1460, 367);
        Seg("M1", 1470, 367, 1600, 367);
        Seg("M9", 1510, 256, 1600, 256);
        Seg("M3", 1510, 477, 1650, 477);
        ...
        Sw(12, 432, 245, "3a", "dL3");
        Sw(13, 1310, 345, "1b", "d15");
        Sw(14, 352, 465, "m6z2", "dB");
        Sw(15, 1185, 243, "3b2", "d15");
        Sw(16, 465, 272, "3a", "d5L");
        ...
        // ===== Поездные =====
        R(false, "Н5", "Ч5", "d5L,5a", (16, false));
        R(false, "Ч5", "Н", "5a,d5L", (16, false));
